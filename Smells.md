...
# Este atributo no se utiliza ya que los coupons son ingresados como parametro (private List<String> coupons;)
...
# Agregue la referencia al atributo orders
